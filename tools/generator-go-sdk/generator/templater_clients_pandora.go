...
var _ templaterForResource = clientsPandoraTemplater{}

type clientsPandoraTemplater struct {
}

func (c clientsPandoraTemplater) template(data ServiceGeneratorData) (*string, error) {
